...
from utils import (write_matrix_txt, get_origin_scaling, get_concat_h, depth2mesh, read_test_data, nmap_normalization,
                   get_test_data)
...
with sess.as_default():
    with refineNet_graph.as_default():
        ...
        saver = tf.train.import_meta_graph(
            pre_ck_pnts_dir_DR + '/model_' + model_num_DR + '/model_' + model_num_DR + '.ckpt.meta')
...
with sess2.as_default():
    with NormNet_graph.as_default():
        ...
        saver2 = tf.train.import_meta_graph(
            pre_ck_pnts_dir_NP + '/model_' + model_num_NP + '/model_' + model_num_NP + '.ckpt.meta')
